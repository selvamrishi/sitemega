...
<?php include 'partials/main.php'; ?>
    ...
    <head>
       ...
       <?php includeFileWithVariables('partials/title-meta.php', array('title' =>'Job Dashboard')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <!-- <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Dashboards', 'title' =>'Job')); ?> -->
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active" data-bs-interval="3000">
                                                    <div class="bg-light p-3 d-flex mb-3 rounded">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="font-size-15 mb-2"><a href="candidate-overview.php" class="text-body">Stephen Hadley</a> <span class="badge badge-soft-info">Freelance</span></h5>
                                                        ...
                                                        <div>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton11">
                                                                    <li><a class="dropdown-item" href="candidate-overview.php">View Details</a></li>
                                                    ...
                                                    <div class="bg-light p-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="font-size-15 mb-2"><a href="candidate-overview.php" class="text-body">Charles Brown</a> <span class="badge badge-soft-success">Full Time</span></h5>
                                                ...
                                                <div class="carousel-item" data-bs-interval="3000">
                                                    <div class="bg-light p-3 d-flex mb-3 rounded">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="font-size-15 mb-2"><a href="candidate-overview.php" class="text-body">Adam Miller</a> <span class="badge badge-soft-warning">Internship</span></h5>
                                                    ...
                                                    <div class="bg-light p-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="font-size-15 mb-2"><a href="candidate-overview.php" class="text-body">Keith Gonzales</a> <span class="badge badge-soft-info">Freelance</span></h5>
                                                ...
                                                <div class="carousel-item" data-bs-interval="3000">
                                                    <div class="bg-light p-3 d-flex mb-3 rounded">
                                                        <img src="assets/images/users/avatar-4.jpg" alt="" class="avatar-sm rounded me-3">
                                                        <div class="flex-grow-1">
                                                            <h5 class="font-size-15 mb-2"><a href="candidate-overview.php" class="text-body">Bonnie Harney</a> <span class="badge badge-soft-success">Full Timer</span></h5>
                                                    ...
                                                    <div class="bg-light p-3 d-flex">
                                                        <img src="assets/images/users/avatar-2.jpg" alt="" class="avatar-sm rounded me-3">
                                                        <div class="flex-grow-1">
                                                            <h5 class="font-size-15 mb-2"><a href="candidate-overview.php" class="text-body">Dolores Minter</a> <span class="badge badge-soft-danger">Part Time</span></h5>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <a href="job-list.php" class="btn btn-primary btn-sm">View All <i class="bx bx-right-arrow-alt"></i></a>
                                    </div>
                                </div>
                            </div><!--end col-->
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            ...
                                            <a href="job-details.php" class="text-body">
                                            ...
                                            <div class="vstack gap-4">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-2 flex-grow-1">
                                                        <h6 class="mb-1 font-size-15"><a href="job-details.php" class="text-body">Marketing Director</a></h6>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                            <li><a class="dropdown-item" href="job-details.php">View Details</a></li>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-2 flex-grow-1">
                                                        <h6 class="mb-1 font-size-15"><a href="job-details.php" class="text-body">Frontend Developer</a></h6>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-2 flex-grow-1">
                                                        <h6 class="mb-1 font-size-15"><a href="job-details.php" class="text-body">React Developer</a></h6>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-2 flex-grow-1">
                                                        <h6 class="mb-1 font-size-15"><a href="job-details.php" class="text-body">NodeJs Developer</a></h6>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-2 flex-grow-1">
                                                        <h6 class="mb-1 font-size-15"><a href="job-details.php" class="text-body">Digital Marketing</a></h6>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-2 flex-grow-1">
                                                        <h6 class="mb-1 font-size-15"><a href="job-details.php" class="text-body">Business Associate</a></h6>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-2 flex-grow-1">
                                                        <h6 class="mb-1 font-size-15"><a href="job-details.php" class="text-body">Backend Developer</a></h6>
