...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty(trim($_POST["useremail"]))) {
        ...
        $body = "Hi, $username. Click here to reset your password: <br><a href=\"$actual_link/auth-password-change.php?token=$token\">$actual_link/auth-reset.php?token=$token</a>";
