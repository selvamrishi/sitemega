...
<?php include 'partials/main.php'; ?>
    ...
    <head>
       ...
       <?php includeFileWithVariables('partials/title-meta.php', array('title' =>'Customers')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Ecommerce', 'title' =>'Customers')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="text-end">
                                        ...
                                        <button type="submit" id="addCustomer-btn" class="btn btn-success">Add Customer</button>
                                    </div>
                                </div>
                            </div>
                        </form>
