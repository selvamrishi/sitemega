...
<?php include 'partials/main.php'; ?>
    ...
    <head>
       ...
       <?php includeFileWithVariables('partials/title-meta.php', array('title' =>'Cart')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Ecommerce', 'title' =>'Cart')); ?>
                                            ...
                                            <table class="table align-middle mb-0 table-nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="product">
                                                        ...
                                                        <td>
                                                            <div class="me-3" style="width: 120px;">
                                                                <input type="text" value="01" class="product-quantity" name="demo_vertical">
                                                            </div>
                                                        </td>
