...
<?php include 'partials/main.php'; ?>
    ...
    <head>
       ...
       <?php includeFileWithVariables('partials/title-meta.php', array('title' =>'Orders')); ?>
    ...
    <?php include 'partials/body.php'; ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Ecommerce', 'title' =>'Orders')); ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div id="orderlist-overview">
                                    ...
                                    <p class="mb-4">Billing Name: <span class="orderlist-customer text-primary">Neal Matthews</span></p>
                ...
                <div class="modal-content">
                    <div class="modal-body px-4 py-5 text-center">
                        ...
                        <div class="hstack gap-2 justify-content-center mb-0">
                            ...
                            <button type="button" class="btn btn-secondary" id="close-removeOrderModal" data-bs-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="assets/js/pages/ecommerce-order-list.init.js"></script>
