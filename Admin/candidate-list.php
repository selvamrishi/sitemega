...
<?php include 'partials/main.php'; ?>
    ...
    <head>
       ...
       <?php includeFileWithVariables('partials/title-meta.php', array('title' =>'Candidate List')); ?>
    ...
    <?php include 'partials/body.php'; ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Jobs', 'title' =>'Candidate List')); ?>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-xxl-4 col-lg-4">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control" id="searchList" autocomplete="off" placeholder="Search your candidate">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-xxl-2 col-lg-6">
                                                    <div class="position-relative h-100 hstack gap-3">
                                                        <button type="submit" class="btn btn-primary h-100 w-100" onclick="filterData();"><i class="bx bx-search-alt align-middle"></i> Find Jobs</button>
        ...
        <!-- candidate-list js -->
        <script src="assets/js/pages/candidate-list.init.js"></script>
